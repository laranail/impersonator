 ...
 * @method static string|null rateLimitKey(\Illuminate\Http\Request|null $request = null)
 * @method static \Simtabi\Laranail\Impersonator\Core\Values\ExtensionOutcome extendSession(\Simtabi\Laranail\Impersonator\Core\Values\ExtensionPolicy|null $policy = null)
 * @method static \Simtabi\Laranail\Impersonator\Core\Values\ExtensionGrant canExtendSession()
 * @method static \Simtabi\Laranail\Impersonator\Core\Values\ExtensionPolicy extensionPolicy()
 ...
 * @method static \Simtabi\Laranail\Impersonator\Laravel\ImpersonationManager approvalEligibilityUsing(\Closure $rule)
