...
class ImpersonationApprovalRequest extends Model
{
    ...
    public function toApprovalRequest(): ApprovalRequest
    {
        ...
        $decidedBy = $this->stringOrNull('decided_by_type');

        return new ApprovalRequest(
            id: $this->str('id'),
            requester: new Identity($this->str('requester_type'), $this->str('requester_id')),
            target: new Identity($this->str('target_type'), $this->str('target_id')),
            ...
            decidedBy: $decidedBy === null
                ? null
                : new Identity($decidedBy, $this->str('decided_by_id')),
            decisionNote: $this->stringOrNull('decision_note'),
