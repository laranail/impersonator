...
class EnterImpersonationRequest extends FormRequest
{
    ...
    {
        return [
            'target_type.in' => 'That type of account cannot be impersonated.',
            'mode.in' => 'That impersonation mode is not available.',
            'guard.in' => 'That authentication guard does not exist.',
        ];
    }
