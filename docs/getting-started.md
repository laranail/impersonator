...
`Impersonator` is a root-namespace alias registered by package discovery. If your application
disables aliases, import the facade class directly — every example below reads the same either way:
